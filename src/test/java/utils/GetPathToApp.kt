...
class GetPathToApp {
    ...
    val fullLocalAppLocalPathIOS = "/Users/$USER_NAME/apps/$appName"
    val fullAppLocalPathAndroid = "/Users/$USER_NAME/apps/$apkName"
    ...
    companion object {
        ...
        private val APK_PATH = File("/Users/$USER_NAME/apps/")
        private val APP_PATH = File("/Users/$USER_NAME/apps/")
    }
}
